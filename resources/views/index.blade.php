...
<body>
      ...
      <div class="row">
        <div class="col-lg-6 d-flex flex-column justify-content-center pt-4 pt-lg-0 order-2 order-lg-1" data-aos="fade-up" data-aos-delay="200">
          ...
          <div class="d-lg-flex">
            ...
            @yield ('video')
            <a href="https://www.youtube.com/watch?v=jDDaplaOz7Q" class="venobox btn-watch-video" data-vbtype="video" data-autoplay="true"> Our Intro <i class="icofont-play-alt-2"></i></a>
          </div>
        </div>
  ...
  <main id="main">
    ...
    <!-- ======= Division Section ======= -->
    <section id="specialities" class="services section-bg">
      <div class="container" data-aos="fade-up">
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <!-- jika ingin edit section contact bisa ke folder partials -->
  ...
  <footer id="footer">
    ...
    <div class="container footer-bottom clearfix">
      ...
      <div class="credits">
        ...
        Templete From <a href="https://bootstrapmade.com/">BootstrapMade</a>
      </div>
    </div>
  </footer><!-- End Footer -->
